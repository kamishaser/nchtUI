...
public:
	...
	std::weak_ptr<GUIelement> trunk; //родитель элемента
	 //позиция вершины родителя, относительно которой была произведена фиксация
	...
	public:
		...
		int pFixPoint = 0; //точка родительского элемента, относительно которой происходит фиксация
		int tFixPoint = 0; //зафиксированная относительно родителя точка, этого элемента
		virtual void draw(glm::vec2 parPointPos) {};
